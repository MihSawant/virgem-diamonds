...
export default function LatestBlog() {
  const breadcrumbItems = [
    { title: 'Blog Grid', url: ``, type: false },
  ];
        ...
        return (
          <div className='2xl:py-28 xl:py-20 md:py-12 py-8 container' key={index}>
            <div className='flex items-start gap-8 lg:flex-nowrap flex-wrap'>
              ...
              {isLoading ? (
                <div className='grid sm:grid-cols-2 grid-cols-1 2xl:gap-5 gap-4 items-start lg:w-2/3 w-full'>
                ...
                <div className='grid sm:grid-cols-2 grid-cols-1 2xl:gap-5 gap-6 items-start lg:w-2/3 w-full'>
                  {blogs.blogs && blogs.blogs.map((item, index) => {
                    return (
                      <div className='relative w-full h-full group' key={index}>
                        <div className='w-full relative'>
                          <Link href={item.slug}>
                            <Image src={item.blog_img} alt={item.blog_alt} title={item.blog_alt} width={500} height={450} className='group-hover:brightness-110 transition-all w-full 1xl:h-[400px] lg:h-[320px] h-[300px] object-cover' />
                          </Link>
                        ...
                        <div className='w-full mt-6'>
                          ...
                          <p className='1xl:mb-5 mb-3 2xl:text-lg lg:text-md text-md text-gray-800 lg:leading-7 '>
                            {item.short_des}
                          </p>
